...
RSpec.describe Comment, type: :model do
  user = User.new(name: 'Abbas', photo: 'profile_picture', bio: 'User 1 called', post_counter: 0)
  ...
  it 'checking comment<' do
    user1 = User.new(name: 'Abbas', photo: 'profile_picture', bio: 'User 1 called', post_counter: 0)
